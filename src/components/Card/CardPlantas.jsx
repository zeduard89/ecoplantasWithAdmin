      ...
      <div onClick={openModal} className='relative text-center rounded-md p-7 h-[25rem] w-[15rem] md:w-[18rem] lg:w-[18rem]'>
        ...
        {truncatedDescription.length > 0 ? (
          <>
            ...
            <h4 className='h-12 text-balance overflow-hidden line-clamp-2 bg-green-700/20 p-2 text-[0.79rem] md:text-sm lg:text-sm'>
              {truncatedDescription}
            </h4>
            <button 
              className='h-10 w-full pb-2 text-balance overflow-hidden font-bold bg-green-700/20 rounded-b-md text-[0.79rem] md:text-sm lg:text-sm'
              onClick={openModal} 
            >
              Leer más
            </button>
          ...
          <>
            ...
            <h4 className='h-12 text-balance overflow-hidden line-clamp-2 bg-green-700/20 p-2 text-[0.79rem] md:text-sm lg:text-sm rounded-b-md'>
            </h4>
          </>
        )}
      </div>
